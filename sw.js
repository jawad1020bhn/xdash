...
const PRECACHE = [
  ...
  "./m3e/fonts.css?v=6",
  "./m3e/tokens.css?v=6",
  "./m3e/components.css?v=6",
  "./css/foundation.css?v=6",
  "./css/workspaces.css?v=6",
  "./css/viewer.css?v=6",
  "./css/settings.css?v=6",
  "./css/mobile.css?v=6",

  "./m3e/color.js?v=6",
  "./m3e/theme.js?v=6",
  "./m3e/interactions.js?v=6",
  "./m3e/media.js?v=6",
  "./m3e/video-controls.js?v=6",
  "./js/demo.js?v=6",
  "./js/store.js?v=6",
  "./js/library.js?v=6",
  "./js/ui.js?v=6",
  ...
  "./js/card.js?v=6",
  "./js/viewer.js?v=6",
  "./js/views/discover.js?v=6",
  "./js/views/library.js?v=6",
  "./js/views/watch.js?v=6",
  "./js/views/settings.js?v=6",
  "./js/views/manage.js?v=6",
  "./js/views/capture.js?v=6",
  "./js/app.js?v=6",
