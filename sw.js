...
const PRECACHE = [
  ...
  "./m3e/fonts.css?v=10",
  "./m3e/tokens.css?v=10",
  "./m3e/components.css?v=10",
  "./css/foundation.css?v=10",
  "./css/workspaces.css?v=10",
  "./css/viewer.css?v=10",
  ...
  "./m3e/color.js?v=10",
  "./m3e/theme.js?v=10",
  "./m3e/interactions.js?v=10",
  "./m3e/media.js?v=10",
  "./m3e/video-controls.js?v=10",
  "./js/demo.js?v=10",
  "./js/store.js?v=10",
  "./js/library.js?v=10",
  "./js/ui.js?v=10",
  ...
  "./js/card.js?v=10",
  "./js/viewer.js?v=10",
  "./js/views/discover.js?v=10",
  "./js/views/library.js?v=10",
  "./js/views/watch.js?v=10",
  "./js/views/settings.js?v=10",
  "./js/views/manage.js?v=10",
  "./js/views/capture.js?v=10",
  "./js/app.js?v=10",
  "./js/pwa.js?v=10",
